...
public class Terminal{
    ...
    public Terminal(CadastrosContas bd) {
        this.meuCaixa = new Caixa(this, bd);
    }

    public Terminal(Terminal cadastro) {
    }
    ...
    public void iniciaOperacao() {
        ...
        while (opcao != 4) {
            switch (opcao) {
                case 1: double saldo = this.meuCaixa.consultasSaldo(getInt("Numero da Conta"), getInt("Senha"));
                    if (saldo != -1) {
                    ...
                    break;
                case 2: boolean b = this.meuCaixa.efetuaSaque(getInt("Numero da Conta"),
    ...
    public Terminal pesquisar(int numeroConta) {
        return null;
    }
    public Terminal(String joaoSilva, String s) {
    }
    ...
    public void inserir(Terminal conta) {
    }
